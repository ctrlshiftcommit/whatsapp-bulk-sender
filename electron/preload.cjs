...
contextBridge.exposeInMainWorld("wasend", {
  ...
  previewContactFile: () => ipcRenderer.invoke("contacts:preview-file"),
  importContactFile: (payload) => ipcRenderer.invoke("contacts:import-file", payload),
  ...
  getDashboardSummary: (days) => ipcRenderer.invoke("dashboard:summary", days),
